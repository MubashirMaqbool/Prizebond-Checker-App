...
public class random_search_database extends AppCompatActivity {
    ...
    DatabaseReference ref200,ref750,ref15000,ref1500,ref25000,ref40000,ref40000pr,ref7500;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_search_database);
        ...
        ArrayAdapter<String> stringArrayAdapter=new ArrayAdapter<String>(random_search_database.this,android.R.layout.simple_list_item_1,item1);
        ...
        ArrayAdapter<String> adapters = new ArrayAdapter<String>(random_search_database.this, android.R.layout.simple_spinner_dropdown_item, item);
                ...
                if(spinner1.getSelectedItem().equals("100")){
                    ...
                    databaseReference1.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(random_search_database.this, android.R.layout.simple_spinner_dropdown_item, items);
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
               ...
               else if(spinner2.getSelectedItem().equals(datevalue_1_25000_019)){
                    showLoading();
                ...
                else if(spinner2.getSelectedItem().equals(datevalue750_1_019)){
                    showLoading();
                    dataFromWeb adress=new dataFromWeb();
                    adress.m = a1_750;
                    adress.execute();
                ...
                else if(spinner2.getSelectedItem().equals(datevalue_7500_1_019)){
                    showLoading();
                    dataFromWeb adress=new dataFromWeb();
                    adress.m = a1_7500;
                    adress.execute();
    ...
    public void Serch_Button(View view) {
        ...
        new CountDownTimer(3000, 3000) {
            ...
            public void onFinish() {
                progressDialog1.dismiss();
                if(spinner1.getSelectedItem().equals("Please Select Your Bond")&&spinner2.getSelectedItem().equals("Select Your Prize Bond Date")){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void showData(String prizebond_data1) {
        final AlertDialog.Builder builder=new AlertDialog.Builder(random_search_database.this);
        ...
        else
        {
            ...
            builder.setMessage(prizebond_data+" ");
        }
    ...
    private void showSearch() {
        progressDialog1=new ProgressDialog(random_search_database.this);
