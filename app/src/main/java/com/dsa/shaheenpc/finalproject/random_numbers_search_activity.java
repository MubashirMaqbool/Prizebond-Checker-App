...
public class random_numbers_search_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_numbers_search_activity);
        ...
        ArrayAdapter<String> stringArrayAdapter=new ArrayAdapter<String>(random_numbers_search_activity.this,android.R.layout.simple_list_item_1,item1);
        ...
        ArrayAdapter<String> adapters = new ArrayAdapter<String>(random_numbers_search_activity.this, android.R.layout.simple_spinner_dropdown_item, item);
                ...
                if(spinner1.getSelectedItem().equals("100")){
                    ...
                    databaseReference1.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(random_numbers_search_activity.this, android.R.layout.simple_spinner_dropdown_item, items);
    ...
    private void showLoading() {
        progressDialog1=new ProgressDialog(random_numbers_search_activity.this);
    ...
    public void list_data(View view){
        ...
        {
            strings.add(editText1.getText().toString());
            stringArrayAdapter.notifyDataSetChanged();
            boolean information= dataBase.InserData(editText1.getText().toString());
        }
        else Toast.makeText(getApplicationContext(),"Enter Valid Number",Toast.LENGTH_SHORT).show();
        editText1.setText("");
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void showData(String prizebond_data1) {
        final AlertDialog.Builder builder=new AlertDialog.Builder(random_numbers_search_activity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==R.id.randomHistory){
            finish();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.random_number, menu);
